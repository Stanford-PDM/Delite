...
trait InterfacesExp extends Interfaces with BaseExp with Effects with Blocks with OverloadHack {
  ...
  override def syms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[Any@unchecked] => syms(i.ops.elem)
    case _ => super.syms(e)
  }

  override def boundSyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[Any@unchecked] => boundSyms(i.ops.elem)
    case _ => super.boundSyms(e)
  }

  override def effectSyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[Any@unchecked] => effectSyms(i.ops.elem)
    case _ => super.effectSyms(e)
  }

  override def softSyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[Any@unchecked] => softSyms(i.ops.elem)
    case _ => super.softSyms(e)
  }

  override def rsyms[T](e: Any)(f: Any=>List[T]): List[T] = e match {
    case i: Interface[Any@unchecked] => rsyms(i.ops.elem)(f)
    case _ => super.rsyms(e)(f)
  }

  override def symsFreq(e: Any): List[(Sym[Any], Double)] = e match {
    case i: Interface[Any@unchecked] => symsFreq(i.ops.elem)
  ...
  override def aliasSyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[Any@unchecked] => aliasSyms(i.ops.elem)
    case _ => super.aliasSyms(e)
  }  

  override def containSyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[Any@unchecked] => containSyms(i.ops.elem)
    case _ => super.containSyms(e)    
  }

  override def extractSyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[Any@unchecked] => extractSyms(i.ops.elem)
    case _ => super.extractSyms(e)   
  }

  override def copySyms(e: Any): List[Sym[Any]] = e match {
    case i: Interface[Any@unchecked] => copySyms(i.ops.elem)
